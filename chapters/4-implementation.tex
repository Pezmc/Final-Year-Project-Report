...
During the process feedback is displayed to the user using notifications that appear over the wizard and are coloured according to validation style convention, with red warning of an error and green confirming success (Fig. \ref{suggestion-notification}). 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{implementation/suggestion-wizard-activity}
...
By following the wizard users are able to quickly map the majority of their transactions, following a more simple activty diagram (Fig. \ref{suggestion-wizard-activity}.
