...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{background/moneymanagerchart}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{background/movingaverages}
...
If a users password is stored in a reversible state, whether that is plain text or encrypted and the database is leaked, not only can the users account on the original website be compromised, but the data can be used attack other websites where the user uses the same username and password.
%
