...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{testing/box-plot-loyalty}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{testing/box-plot-usability}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{testing/difficulty-bar}
...
Overall the system performed with 13\% average error, performing with a lower average error of 9\% for income. It is likely that income has a lower error as the income is often regular and for similar amounts.
%
