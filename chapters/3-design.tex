...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{design/simple-mappings}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{design/security/sniffing}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{design/security/hijacking}
