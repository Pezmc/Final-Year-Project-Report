...
\todo{This could be extended further by fitting to just one (or many functions) and adjusting a decay constant}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\todo[inline]{I am here in proof read 1}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\missingfigure{Showing how the one with the least error is selected}
