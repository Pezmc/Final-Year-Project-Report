...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{design/security/sniffing}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{design/security/hijacking}
