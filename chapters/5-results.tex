...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/welcome-dashboard}
...
The suggestion wizard steps the user though all unmapped and uncategorised transactors, starting with the one they frequent the most often and prompts them to provide the mapping, either by following a suggestion, creating a new transactor or manually searching for a match.
