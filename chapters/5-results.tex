...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/dashboard-full}
...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/piecharthover}
...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/wizard-screen}
...
\begin{figure}
\centering
\includegraphics{implementation/suggestion-notification}
\caption{Notifications following correctly completing a mapping}
...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/wizard-create-dropdown}
...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/wizard-create}
...
\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/wizard-map}
...
After completing the wizard, by mapping of ignoring all the unmapped references, the user is congratulated and a hint is given that they should head to the transaction summary page, which includes their monthly expenditure predictions.

\section{Transaction Overview}

\begin{figure}
\centering
\includegraphics{screenshots/walkthrough/statement-view}
\caption{The statement view}
\label{fig:statement-view}
\end{figure}

\section{Statements}
The application also provides an easy way to view historical spending organised by month (Fig \ref{fig:}. The transactions in each month can be grouped by category, transactor or date to give a more detailed idea of how money is being spent.
